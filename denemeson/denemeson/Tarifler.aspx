<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Tarifler.aspx.cs" Inherits="denemeson.Tarifler" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" style="height:auto"  runat="server" CssClass="auto-style9" Height=500px>
        <table class="auto-style4">
            <tr>
                ...
                <td class="auto-style24">Onaysız Tarif Listesi</td>
            </tr>
        </table>
                    ...
                    <table class="auto-style4">
                        <tr>
                            ...
                            <td class="auto-style16">
                               <a href="TarifOnerDetay.aspx?TarifId=<%#Eval("TarifId") %>"> <asp:Image ID="Image3" runat="server" Height="40px" ImageUrl="~/İkon/proposal.png" Width="40px" /></a>
                                </td>
                        </tr>
                    </table>
                </ItemTemplate>
    ...
    <asp:Panel ID="Panel3" style="height:auto"  runat="server" CssClass="auto-style9" Height=500px>
        <table class="auto-style4">
            <tr>
                <td class="auto-style22"><strong>
                ...
                <td class="auto-style24">Onaylı Tarif Listesi</td>
            </tr>
        </table>
