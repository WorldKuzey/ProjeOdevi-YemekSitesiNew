<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="KategoriDetay.aspx.cs" Inherits="denemeson.KategoriDetay" %>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style6"><strong><a href="YemekDetay.aspx?Yemekid=<%#Eval("Yemekid") %>">
                    ...
                    </a><%--? işareti web sayfalarında kullanılan web formları(geçişlerde) arası veri taşıma işlemleri için kullanılır)--%><%--tıkladığımız yemeğin id sinive verilerini eval sayesinde alıyoruz--%></strong></td>
            </tr>
            <tr>
